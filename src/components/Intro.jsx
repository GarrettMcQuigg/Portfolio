...
function Intro() {
  return (
    <div className='flex items-center justify-center flex-col text-center pt-24'>
      ...
      <p className='pt-3 pb-5 text-4xl font-bold text-gray-400'>Software Engineer & Web Developer</p>
      <p className='text-lg max-w-2xl p-4 leading-7'>
        I'm a full stack developer with a passion to learn and the drive to problem solve. <br />I received my bachelors degree from the{' '}
        <b className='text-lime-500'>University of Arkansas</b> as well as my full stack certifications from the <b className='text-lime-500'>Springboard</b>{' '}
      ...
      <a className='rounded border-2 border-lime-500 py-3 px-8 hover:bg-lime-900/[0.2]' href=''>
        <span className='text-lime-500 tracking-wider'>
          <b>
            <a href='https://drive.google.com/file/d/1GrjSCQNvXvGYT5tJi94DqyQLUaXK68KU/view' target='_blank'>Résumé</a>
          </b>
        </span>
      </a>
    </div>
